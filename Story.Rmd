...
[ ] See all data
[ ] Ask ChatGPT to gain insights

# Tasks

Breaking down this:
- Financial Strengths:
  + Very low valuation metrics compared to peers.
  + Positive net earnings and increasing revenue.
- Financial Weaknesses:
  + Market capitalization has decreased.
- Analysis: 
ADRO exhibits strong financial performance with very low valuation metrics, making it an attractive option for long-term investment despite the recent decrease in market capitalization.

## Earnings Comparison (line plot)
[x] Explain what earning is
[x] Make Visualization comparing all earnings
[x] Conclusion
[x] Export image and fit them

## P/E Comparison (bar plot)
[x] Explain what P/E is
[x] Make Visualization comparing all P/Es
[x] Conclusion
[x] Export image and fit them

## P/B Comparison (bar plot)
[x] Explain what P/B is
[x] Make Visualization comparing all P/Bs
[x] Conclusion
[x] Export image and fit them

## P/S Comparison
[x] Explain what P/S is
[x] Make Visualization comparing all P/Ss
[x] Conclusion
[x] Export image and fit them

Others
[ ] Write background
[ ] Write comments to all code
[ ] Mention Sectors App as the data source

Conclusion
`BYAN.JK` is overvalued. 
